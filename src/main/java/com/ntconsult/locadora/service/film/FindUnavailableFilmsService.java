...
@Service
public class FindUnavailableFilmsService {

    private final FilmRepository repository;

    public FindUnavailableFilmsService(FilmRepository repository) {
        this.repository = repository;
    }

    public BaseDto execute() {
        List<Film> availableFilms = repository.findByAvailableIsFalse();
        ResponseSuccessBuilder<List<Film>> successBuilder = new ResponseSuccessBuilder(HttpStatus.OK, availableFilms);
